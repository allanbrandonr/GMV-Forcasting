...
# save
# write.csv(all_forecasts, "10_optimize_forecast/all_forecasts_gmv_vs_ads_spend_ecr_1.csv", row.names = F)
write.csv(all_forecasts, "10_optimize_forecast/all_forecasts_gmv_vs_ads_spend_ecr_2.csv", row.names = F)


# append sets
all_forecasts_1 <- read_csv("10_optimize_forecast/all_forecasts_gmv_vs_ads_spend_ecr_1.csv")
all_forecasts_2 <- read_csv("10_optimize_forecast/all_forecasts_gmv_vs_ads_spend_ecr_2.csv")

all_forecasts <- rbind(all_forecasts_1, all_forecasts_2)
write.csv(all_forecasts, "10_optimize_forecast/all_forecasts_gmv_vs_ads_spend_ecr.csv", row.names = F)
